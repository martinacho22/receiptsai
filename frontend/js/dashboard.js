    ...
    container.innerHTML = `
      ...
      <div class="table-container">
        <table>
          ...
          <tbody>
            ${driverArray.length === 0 ? '<tr><td colspan="7" class="text-center" style="color:var(--text-muted);padding:32px;">No hay datos de conductores — los comprobantes aparecerán aquí cuando los empleados envíen recibos</td></tr>' : ''}
            ${driverArray.map(d => `
              <tr>
